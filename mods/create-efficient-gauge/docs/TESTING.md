# Create Efficient Gauge test and profiling guide
...
`mods/create-efficient-gauge/build/libs`.

## Development client

```powershell
$env:JAVA_HOME = 'path-to-jdk-21'
.\gradlew.bat :mods:create-efficient-gauge:runClient
```
...
`runs/create-efficient-gauge/` directory.
...
```powershell
.\gradlew.bat :mods:create-efficient-gauge:dependencyInsight `
