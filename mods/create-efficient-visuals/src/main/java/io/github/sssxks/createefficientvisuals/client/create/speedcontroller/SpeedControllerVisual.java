package io.github.sssxks.createefficientvisuals.client.create.speedcontroller;
...
import io.github.sssxks.createefficientvisuals.mixin.create.SpeedControllerBlockEntityAccessor;
    ...
    private void refreshBracket(boolean updateTransform) {
        boolean hasBracket =
            ((SpeedControllerBlockEntityAccessor) blockEntity)
                .createefficientvisuals$hasBracket();
